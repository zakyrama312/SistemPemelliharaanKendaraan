            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('pemeliharaan/' . $pm->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <label for="inputEmail" class="col-sm-4 col-form-label">Tanggal Pemeliharaan <sup
                                    class="text-danger">*</sup></label>
                            <div class="col-sm-8">
                                <input type="text"
                                    class="form-control format-tanggal @error('tanggal') is-invalid @enderror"
                                    name="tanggal"
                                    value="{{ old('tanggal', Carbon::parse($pm->tanggal_pemeliharaan_sebelumnya)->format('d/m/Y')) }}">
