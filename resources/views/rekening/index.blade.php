...
@section('main')
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      ...
      <div class="card">
        <div class="card-body">
        <h5 class="card-title"><a href="/rekening/tambah-rekening" class="btn btn-outline-primary">Tambah
          Rekening</a></h5>
    ...
    @endif
        ...
        <td>
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#basicModal{{ $rek->id }}"><i
