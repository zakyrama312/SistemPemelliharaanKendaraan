        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ url('rekening/' . $rekening->slug) }}" method="POST">
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Nama Rekening <sup class="text-danger">*</sup></label>
                <div class="col-sm-10">
                  <input type="text" class="form-control @error('nama_rek') is-invalid @enderror" name="nama_rek"
                    value="{{ old('nama_rek', $rekening->nama_rekening) }}">
                  @error('nama_rek')
          ...
          @enderror
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control @error('saldo') is-invalid @enderror" name="saldo"
                    value="{{ old('saldo', $rekening->saldo_awal) }}">
                  @error('saldo')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
                </div>
              ...
              <div class="row mb-3">
                <div class="col-sm-6">
                  <small><i>Tanda bintang (<sup class="text-danger"> * </sup>) di samping label kontrol formulir
