...
@section('main')
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      ...
      <div class="card">
        <div class="card-body">
        <h5 class="card-title"><a href="/kendaraan/tambah-kendaraan" class="btn btn-outline-primary">Tambah
          Kendaraan</a></h5>
    ...
    @endif
        ...
        <td><img src="{{ asset('kendaraanImage/' . $kndr->foto) }}" alt="Foto Kendaraan" width="100"></td>
        <td>{{ $kndr->user->name }}</td>
        <td>{{ $kndr->status }}</td>
        <td>
        <a href="{{ url('kendaraan/' . $kndr->slug . '/edit') }}"><i
          class="bi bi-pencil-square text-warning"></i></a>
        <a href="#" data-bs-toggle="modal" data-bs-target="#basicModal{{ $kndr->id }}"><i
