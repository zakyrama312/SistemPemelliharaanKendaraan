                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label class=" col-form-label">Tahun Pembuatan <sup
                                                    class="text-danger">*</sup></label>
                                            <input type="date" class="form-control @error('tahun_pembuatan') is-invalid @enderror"
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label class="col-form-label">Masa Aktif Pajak Tahunan <sup
                                                    class="text-danger">*</sup></label>
                                            <input type="date" class="form-control @error('masa_aktif_pajak_tahunan') is-invalid @enderror"
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label class="col-form-label">Masa Aktif Plat <sup
                                                    class="text-danger">*</sup></label>
                                            <input type="date" class="form-control @error('masa_aktif_plat') is-invalid @enderror"
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label class="col-form-label">Tanggal Pemeliharaan Sebelumnya <sup
                                                    class="text-danger">*</sup></label>
                                            <input type="date" class="form-control @error('tanggal_pemeliharaan') is-invalid @enderror"
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label class="col-form-label">Biaya Pemeliharaan Sebelumnya <sup
                                                    class="text-danger">*</sup></label>
                                            <input type="number" class="form-control @error('biaya_pemeliharaan') is-invalid @enderror"
                                            name=" biaya_pemeliharaan" value="{{ old('biaya_pemeliharaan') }}">
                                        @error('biaya_pemeliharaan')
                                        <div class=" invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-sm-4 mb-3">
                                            <label class="col-form-label">Nomor Rangka <sup
                                                    class="text-danger">*</sup></label>
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label class="col-form-label">Nomor Mesin <sup
                                                    class="text-danger">*</sup></label>
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="jumlah_roda" value="{{ old('jumlah_roda') }}">
                                    </div>
                                    <div class=" col-sm-4 mb-3">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <select class="form-control @error('id_rek') is-invalid @enderror" name="
                                                id_rek">
